...
public class DataLoader implements ApplicationRunner {
    ...
    private void seedWebsiteSettings() {
        List<String[]> settings = List.of(
                new String[]{"site_name",        "KV Construction & Interior",                                                        "text"},
                ...
                new String[]{"contact_hours_weekday",  "8:00 AM – 6:00 PM",                                                          "text"},
                new String[]{"contact_hours_saturday", "9:00 AM – 4:00 PM",                                                          "text"},
                new String[]{"contact_hours_sunday",   "Closed",                                                                     "text"},
                new String[]{"contact_map_label",  "KV Construction and Interior",                                                   "text"},
                new String[]{"contact_map_embed",  "https://maps.google.com/maps?q=KV+Construction+and+Interior@14.4471846,75.935732&z=17&output=embed", "textarea"},
                new String[]{"facebook_url",      "#",                                                                               "url"},
                new String[]{"linkedin_url",      "#",                                                                               "url"},
                new String[]{"twitter_url",       "#",                                                                               "url"},
                new String[]{"instagram_url",     "#",                                                                               "url"},
                new String[]{"about_text",        "KV Construction & Interior has been shaping skylines and communities for over three decades. We combine time-tested craftsmanship with modern technology to deliver projects that stand the test of time.",
                                                                                                                                     "textarea"},
                new String[]{"hero_title",        "KV Construction & Interior",                                                        "text"},
